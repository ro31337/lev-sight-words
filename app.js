...
setTimeout(async () => {
  ...
  const initWl = () => {
    ...
    const data = [
      ["and", getWeight("and", 6), getWord("and")],
      ["for", getWeight("for", 6), getWord("for")],
      ["the", getWeight("the", 6), getWord("the")],
      ["a", getWeight("a", 6), getWord("a")],
      ["in", getWeight("in"), getWord("in")],
      ["is", getWeight("is", 6), getWord("is")],
      ...
      ["like", getWeight("like", 6), getWord("like")],
      ["we", getWeight("we"), getWord("we")],
      ["have", getWeight("have", 6), getWord("have")],
      ["want", getWeight("want"), getWord("want")],
      ["who", getWeight("who"), getWord("who")],
      ["look", getWeight("look", 6), getWord("look")],
      ["this", getWeight("this"), getWord("this")],
      ["what", getWeight("what"), getWord("what")],
      ["me", getWeight("me", 6), getWord("me")],
      ["are", getWeight("are", 6), getWord("are")],
      ["he", getWeight("he", 6), getWord("he")],
      ["she", getWeight("she", 6), getWord("she")],
      ["too", getWeight("too"), getWord("too")],
      ["play", getWeight("play", 6), getWord("play")],
      ["my", getWeight("my", 8), getWord("my")],
      ["little", getWeight("little", 8), getWord("little")],
      ["where", getWeight("where", 8), getWord("where")],
      ["here", getWeight("here", 8), getWord("here")],
      ["with", getWeight("with", 8), getWord("with")],
      ["said", getWeight("said", 8), getWord("said")],
      ["was", getWeight("was", 8), getWord("was")],
    ];
